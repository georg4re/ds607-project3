...
#load linkedin scraping functions
source("LINK FOR LINKEDIN_SCRAPER_FUNCTIONS")

#log rvest into linkedin
library(rvest) 
...
#scrape linkedin
df_linkedIn<-linkedIn_scrape(link_base_url = base_url,max=max)