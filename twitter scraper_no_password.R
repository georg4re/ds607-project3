...
url<-"https://raw.githubusercontent.com/JackJosephWright/password-files-for-r/main/twitter_passwords.csv?token=AQZFVAPBLSVGKEHECGNA43C7PXDS4"
twitter_passwords<-read.csv(url)
